...
@Model class Team: ModelProtocol { 
    ...
    func toDTO() -> TeamDTO {
        return TeamDTO(id: id, teamName: teamName, createdBy: createdBy, headcoach: headcoach, joinCode: joinCode, email: email, createdAt: createdAt, updatedAt: updatedAt, deletedAt: deletedAt)
    }
} 
