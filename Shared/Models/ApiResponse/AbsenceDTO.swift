...
struct AbsenceDTO: DTOProtocol {
    ...
    func toModel() -> Absence {
        Absence(id: id, userAccountId: userAccountId, teamId: teamId, startDate: startDate, endDate: endDate, createdAt: createdAt, updatedAt: updatedAt, deletedAt: deletedAt)
    }
} 
