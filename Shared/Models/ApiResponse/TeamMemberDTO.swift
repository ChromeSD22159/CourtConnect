...
struct TeamMemberDTO: DTOProtocol {
    ...
    init(id: UUID = UUID(), userAccountId: UUID, teamId: UUID, shirtNumber: Int?, role: String, createdAt: Date, updatedAt: Date, deletedAt: Date? = nil) {
        self.id = id
    ...
    func toModel() -> TeamMember {
        return TeamMember(id: id, userAccountId: userAccountId, teamId: teamId, shirtNumber: shirtNumber, role: role, createdAt: createdAt, updatedAt: updatedAt, deletedAt: deletedAt)
    }
}
